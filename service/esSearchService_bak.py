...
#
#         self._matchSectionListFront = ["street", "community", "natural_village", "road", "courtyard",
#                                        "group_number", "address_number", "building_name", "building_site", "unit",
#                                        "floor", "room"]
#
#         self._matchSectionListBackFirst = ["street", "group_number", "address_number", "building_site", "unit",
#                                            "floor", "room", "company"]
#
...
#                         # self._vagueSearchWords = addressParser.getVagueSearchWords()
#                     except:
...
#                     if len(searchParam["query"]["bool"]["must"]) > 0:
...
#             must = searchParam["query"]["bool"]["must"]
...
#         not_ch_ct = 0.0
#         for k in vDict.keys():
#             if not has_chinese_characters(k):
#                 not_ch_ct += 1.0
#         if int(not_ch_ct) != ct:
#             minimum_should_match = str(int(((not_ch_ct + 1) / ct) * 100)) + "%"
#
#         param = {
#             "bool": {
#                 "should": [],
#                 "minimum_should_match": minimum_should_match if not isAccurate and not isFront else match_percent
#             }
#         }
#         ct = 0
...
#
#     def searchByFullName(self, resultDict):
#         """
#         模糊匹配
#         :param resultDict: 分词结果
#         """
#
#         words = []
#         for k in self._JUDGE_HAS_WORDS:
#             if k in resultDict.keys():
#                 words.append(resultDict[k])
#
#         # 进行模糊查询的條件
#         if len(words) > 4:
#             return None, False
...
#             print(searchParam)
#
#         ret = self._doAddressSearch(searchParam, self._searchMain, False)
